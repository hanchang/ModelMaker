	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '/img/progress/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/img/progress/progressbg_red.gif',
									30: '/img/progress/progressbg_orange.gif',
									70: '/img/progress/progressbg_green.gif'
								},
